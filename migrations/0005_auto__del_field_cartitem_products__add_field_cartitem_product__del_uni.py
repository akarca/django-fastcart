...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'fastcart_cartitem', 'product',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'CartItem.products'
        raise RuntimeError("Cannot reverse this migration. 'CartItem.products' and its values cannot be restored.")
