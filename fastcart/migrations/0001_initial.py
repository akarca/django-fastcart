...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'fastcart_cart', (
            ...
            ('site', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['custom_sites.Site'])),
        ...
        db.create_table(u'fastcart_cartitem', (
            ...
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['product.Book'])),
    ...
    models = {
        ...
        u'fastcart.cart': {
            'Meta': {'ordering': "['-updated_on']", 'object_name': 'Cart'},
