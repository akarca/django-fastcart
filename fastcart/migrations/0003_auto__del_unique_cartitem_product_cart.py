...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'CartItem', fields ['product', 'cart']
        db.delete_unique(u'fastcart_cartitem', ['product_id', 'cart_id'])


    def backwards(self, orm):
        # Adding unique constraint on 'CartItem', fields ['product', 'cart']
        db.create_unique(u'fastcart_cartitem', ['product_id', 'cart_id'])
