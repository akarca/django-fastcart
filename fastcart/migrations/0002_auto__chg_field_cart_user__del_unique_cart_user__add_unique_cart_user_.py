...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Cart', fields ['user', 'site']
        db.create_unique(u'fastcart_cart', ['user_id', 'site_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Cart', fields ['user', 'site']
        db.delete_unique(u'fastcart_cart', ['user_id', 'site_id'])
