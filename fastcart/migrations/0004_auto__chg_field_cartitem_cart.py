...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CartItem.cart'
        db.alter_column(u'fastcart_cartitem', 'cart_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['fastcart.Cart']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'CartItem.cart'
        raise RuntimeError("Cannot reverse this migration. 'CartItem.cart' and its values cannot be restored.")
    ...
    models = {
        ...
        u'fastcart.cart': {
            'Meta': {'ordering': "['-updated_on']", 'unique_together': "(('user', 'site'),)", 'object_name': 'Cart'},
            'created_on': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'site': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['custom_sites.Site']"}),
            'updated_on': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'db_index': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['account.CustomUser']", 'null': 'True', 'blank': 'True'})
        },
        u'fastcart.cartitem': {
            'Meta': {'ordering': "['-created_on']", 'object_name': 'CartItem'},
            'cart': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'items'", 'null': 'True', 'to': u"orm['fastcart.Cart']"}),
            'created_on': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'product': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['product.Book']"}),
